...
export default function About() {
    ...
    return (
        <div className="about component">
            ...
            <h4><span className="rect-s">+20</span> IT Projects ({new Date().getFullYear() - 2022} years)</h4>
            <h4><span className="rect-s">+250</span> Graphic Design Projects ({new Date().getFullYear() - 2018} years)</h4>
